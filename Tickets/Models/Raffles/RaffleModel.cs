...
namespace Tickets.Models.Raffles
{
    public class RaffleModel
    {
        ...
        internal RequestResponseModel GetRaffleConsignation()
        {
            ...
            var prospectModel = new ProspectModel();
            var raffles = context.Raffles.AsEnumerable()
                .Where(s => s.Statu == (int)RaffleStatusEnum.Active || s.Statu == (int)RaffleStatusEnum.Planned || s.Statu == (int)RaffleStatusEnum.Generated)
        ...
        internal RequestResponseModel GetRaffleForElectronicSales()
        {
            ...
            var prospectModel = new ProspectModel();
            var raffles = context.Raffles.AsEnumerable()
                .Where(s => s.Statu == (int)RaffleStatusEnum.Active || s.Statu == (int)RaffleStatusEnum.Generated || s.Statu == (int)RaffleStatusEnum.Planned)
                .OrderByDescending(r => r.Id)
                .Select(r => new
                {
                    value = r.Id,
        ...
        internal RequestResponseModel GetRaffleForAllocationSelect()
        {
            ...
            var prospectModel = new ProspectModel();
            var raffles = context.Raffles.AsEnumerable()
                .Where(s => ((s.Statu == (int)RaffleStatusEnum.Active || s.Statu == (int)RaffleStatusEnum.Planned) && s.EndAllocationDate >= DateTime.Now))
                .OrderByDescending(r => r.Id)
                .Select(r => new
                {
                    value = r.Id,
