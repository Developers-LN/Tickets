/**=========================================================
 * Module: ReturnedGroupDetailsClientController
 =========================================================*/
...
(function () {
    ...
    angular
        .module('naut')
        .controller('ReturnedGroupDetailsClientController', ReturnedGroupDetailsClientController);

    ReturnedGroupDetailsClientController.$inject = ['$scope', '$state', '$rootScope', '$stateParams'];
    function ReturnedGroupDetailsClientController($scope, $state, $rootScope, $stateParams) {
        ...
        this.loadReturneds = function () {
            ...
            $.ajax({
                ...
                url: $rootScope.serverUrl + 'ticket/ticketReturnedApi/detailsClient?group=' + $stateParams.group + '&clientId=' + $stateParams.clientId + '&raffleId=' + $stateParams.raffleId,
