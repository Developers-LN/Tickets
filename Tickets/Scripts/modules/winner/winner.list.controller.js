/**=========================================================
 * Module: WinnerListController.js
 =========================================================*/
...
(function () {
    ...
    angular
        .module('naut')
        .controller('WinnerListController', WinnerListController);

    WinnerListController.$inject = ['$scope', '$rootScope', '$state'];
    function WinnerListController($scope, $rootScope, $state) {
        var self = this;
