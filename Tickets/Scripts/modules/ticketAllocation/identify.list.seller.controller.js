/**=========================================================
 * Module: IdentifySellerAwardListController.js
 =========================================================*/
...
(function () {
    ...
    angular
        .module('naut')
        .controller('IdentifySellerAwardListController', IdentifySellerAwardListController);

    IdentifySellerAwardListController.$inject = ['$scope', '$state', '$rootScope'];

    function IdentifySellerAwardListController($scope, $state, $rootScope) {
        var self = this;
        ...
        self.loadIdentifys = function (raffleId, clientId) {
            ...
            $.ajax({
                ...
                url: 'TicketAllocation/GetIdentifySellerList?raffleId=' + raffleId + '&clientId=' + clientId,
