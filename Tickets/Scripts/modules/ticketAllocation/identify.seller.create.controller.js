/**=========================================================
 * Module: IdentifySellerAwardController.js
 =========================================================*/
...
(function () {
    ...
    angular
        .module('naut')
        .controller('IdentifySellerAwardController', IdentifySellerAwardController);

    IdentifySellerAwardController.$inject = ['$scope', '$state', '$rootScope', '$stateParams'];
    function IdentifySellerAwardController($scope, $state, $rootScope, $stateParams) {
        var self = this;
        ...
        $scope.addSellerNumber = function () {
            ...
            $.ajax({
                type: 'POST',
                dataType: 'json',
                url: 'TicketAllocation/ValidateSellerNumberAward?number=' + $scope.number + '&ClientId=' + $scope.identifyBach.ClientId,
                data: $scope.number,
                success: function (data) {
                    window.loading.hide();
                    if (data.result === true) {
                        ...
                        $scope.IdentityAwards = [];
                        $scope.identifyBach.IdentifyNumbers.forEach(function (i) {
                            awardSellerDetail(i.NumberId, i.RaffleId, i.FractionFrom, i.FractionTo);
                        });
        ...
        function awardSellerDetail(number, raffleId, fractionFrom, fractionTo) {
            $.ajax({
                type: 'GET',
                contentType: 'application/json; charset=utf-8',
                url: $rootScope.serverUrl + 'ticket/ticketAllocationApi/awardSellerNumberDetails?number=' + number + '&raffleId=' + raffleId + '&fractionFrom=' + fractionFrom + '&fractionTo=' + fractionTo,
