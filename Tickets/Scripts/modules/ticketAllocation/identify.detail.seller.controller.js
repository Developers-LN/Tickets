/**=========================================================
 * Module: IdentifyAwardSellerDetailController.js
 =========================================================*/
...
(function () {
    ...
    angular
        .module('naut')
        .controller('IdentifyAwardSellerDetailController', IdentifyAwardSellerDetailController);

    IdentifyAwardSellerDetailController.$inject = ['$scope', '$state', '$rootScope', '$stateParams'];
    function IdentifyAwardSellerDetailController($scope, $state, $rootScope, $stateParams) {
        var self = this;
        ...
        this.loadIdentifyData = function () {
            ...
            $.ajax({
                ...
                url: 'TicketAllocation/GetIdentifySellerDetilsData?identifyId=' + $stateParams.identifyId,
