...
(function() {
    ...
    angular
        .module('naut')
        .controller('ClientGeneraReportController', ClientGeneraReportController);

    ClientGeneraReportController.$inject = ['$scope', '$state', '$rootScope', '$stateParams'];
    function ClientGeneraReportController($scope, $state, $rootScope, $stateParams) {
        $scope.cash = {
            EndDate: undefined,
            StartDate: undefined,
            RaffleId: 0,
        ...
        $scope.printClientReport = function () {
            ...
            window.open('Reports/ClientGeneralReport?startDate=' + $scope.cash.StartDate + '&endDate=' + $scope.cash.EndDate + '&clientId=' + $scope.cash.ClientId + '&raffleId=' + $scope.cash.RaffleId);
        }
    }
