/**=========================================================
 * Module: AccountReceivableCloseReportsController.js
 =========================================================*/
...
(function () {
    ...
    angular
        .module('naut')
        .controller('AccountReceivableCloseReportsController', AccountReceivableCloseReportsController);

    AccountReceivableCloseReportsController.$inject = ['$scope', '$state', '$rootScope', '$stateParams'];
    function AccountReceivableCloseReportsController($scope, $state, $rootScope, $stateParams) {
        $scope.cash = {
            EndDate: undefined,
            StartDate: undefined,
            RaffleId: 0,
