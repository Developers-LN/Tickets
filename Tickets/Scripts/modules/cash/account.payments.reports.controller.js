...
(function () {
    ...
    angular
        .module('naut')
        .controller('AccountPaymentsReportsController', AccountPaymentsReportsController);

    AccountPaymentsReportsController.$inject = ['$scope', '$state', '$rootScope', '$stateParams'];
    function AccountPaymentsReportsController($scope, $state, $rootScope, $stateParams) {
        $scope.cash = {
            EndDate: undefined,
            StartDate: undefined,
            RaffleId: 0,
