...
(function() {
    ...
    angular
        .module('naut')
        .controller('AccountsReceivablesReportsController', AccountsReceivablesReportsController);

    AccountsReceivablesReportsController.$inject = ['$scope', '$state', '$rootScope', '$stateParams'];
    function AccountsReceivablesReportsController($scope, $state, $rootScope, $stateParams) {
        $scope.cash = {
            EndDate: undefined,
            StartDate: undefined,
            RaffleId: 0,
        ...
        $scope.printReport = function () {
            ...
            window.open('Reports/ClientBalanceGeneralReport?startDate=' + $scope.cash.StartDate + '&endDate=' + $scope.cash.EndDate + '&clientId=' + $scope.cash.ClientId + '&raffleId=' + $scope.cash.RaffleId);
        }
    }
})();
