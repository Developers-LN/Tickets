...
(function() {
    ...
    angular
        .module('naut')
        .controller('AwardsCertificationApprovedController', AwardsCertificationApprovedController);

    AwardsCertificationApprovedController.$inject = ['$scope', '$rootScope', '$state', '$stateParams'];
    function AwardsCertificationApprovedController($scope, $rootScope, $state, $stateParams) {
        var self = this;
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.result === true) {
                        ...
                        $state.go('app.awardsCertWorkflowList');
                    } else {
